...
public class ButtonsNTexta extends JPanel{
	
	public JTextField TextLine;
	public JToggleButton UpperCaseButton, LowerCaseButton, SelectedButton;
	public JCheckBox ContinuosButton;
	public int caretPos;
	
	public ButtonsNTexta(){
    ...
    public static void main (String args[]) {
        ...
        frame.getContentPane().add(new ButtonsNTexta());
        frame.pack(); 
